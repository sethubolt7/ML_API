...
def run_script():
    ...
    # Load the models
    filter_1 = load_model("models\\filter_1.h5")
    filter_2 = load_model("models\\filter_2.h5")
    ...
    # class names
    class_names1 = ["Class 0 unwanted", "Class 1 water issues"]
    class_names2 = ["Class 0 fresh water", "Class 1 water issues"]
    ...
    result_text = ''
    if predicted_class1 == "Class 1 water issues":
        result_text += f"filter_1 says: {predicted_class1}\n"
        if predicted_class2 == "Class 1 water issues":
            result_text += f"filter_2 says: {predicted_class2}\n"
